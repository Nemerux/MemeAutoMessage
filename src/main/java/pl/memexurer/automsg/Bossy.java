...
public class Bossy {
     ...
     */
    public void setPercent(Player player, int percent) {
        BossBar bar = getBossBar(player);
     ...
     * @param percent A value in the range [0,1]
     */
    public void set(Player player, String text, int percent) {
        BossBar bar = getBossBar(player);
    ...
    private BossBar newBossBar(Player player, String text, int percent) {
    ...
    private class BossBar {
        ...
        public BossBar(Player player, String text, int health, Location location, boolean spawned) {
            this.player = player;
            this.text = text;
            this.health = health;
